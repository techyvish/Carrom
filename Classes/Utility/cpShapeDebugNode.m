...
@interface cpShapeDebugNode (PrivateMethods)
...
@implementation cpShapeDebugNode
...
- (void) draw
{
	...
	switch(myShape->klass->type)
	{
		case CP_CIRCLE_SHAPE:
		{
			//Circle's are somewhat unique with this offset variable
			cpVect offset = cpCircleShapeGetOffset(myShape);
